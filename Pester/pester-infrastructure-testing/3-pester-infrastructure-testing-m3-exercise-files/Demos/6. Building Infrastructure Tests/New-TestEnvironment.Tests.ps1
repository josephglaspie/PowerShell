describe 'New-TestEnvironment' {
    ...
    $jsonPath = "C:\gitHubPersonal\ScriptsHome\Pester\pester-infrastructure-testing\3-pester-infrastructure-testing-m3-exercise-files\Demos\6. Building Infrastructure Tests\ConfigurationItems.json"
